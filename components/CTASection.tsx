  ...
  return (
    <section className="bg-primary text-white py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative">
        <p className="text-xs font-bold tracking-[0.3em] uppercase text-accent mb-4">PromptCraft 1</p>
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <CheckoutButton className="btn-primary text-base px-8 py-3.5" label={primaryLabel} />
